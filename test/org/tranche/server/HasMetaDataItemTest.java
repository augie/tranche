 ...
 */
public class HasMetaDataItemTest extends TrancheTestCase {
    ...
    public void testDoAction() throws Exception {
        TestUtil.printTitle("HasMetaDataItemTest:testDoAction()");
        ...
        try {
            ...
            // create the item
            HasMetaDataItem item = new HasMetaDataItem(s);

            // create the bytes
            ByteArrayOutputStream request = new ByteArrayOutputStream();
            HasMetaDataItem.writeRequest(false, hashes, request);
