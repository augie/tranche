 ...
 */
public class GetDataHashesItemTest extends TrancheTestCase {
    ...
    public void testDoAction() throws Exception {
        TestUtil.printTitle("GetDataHashesItemTest:testDoAction()");
        ...
        try {
            ...
            // create the item
            GetDataHashesItem item = new GetDataHashesItem(s);

            // all
            {
                // create the bytes
                ByteArrayOutputStream request = new ByteArrayOutputStream();
                GetDataHashesItem.writeRequest(false, 0, numChunks, request);
            ...
            // part
            {
                // create the bytes
                ByteArrayOutputStream request = new ByteArrayOutputStream();
                GetDataHashesItem.writeRequest(false, numChunks/2, numChunks, request);
