 ...
 */
public class SetMetaDataItemTest extends TrancheTestCase {
    ...
    public void testDoAction() throws Exception {
        TestUtil.printTitle("SetMetaDataItemTest:testDoAction()");
        ...
        try {
            ...
            byte[] bytesToUpload = DevUtil.createRandomMetaDataChunk();
            ...
            // create the item
            SetMetaDataItem item = new SetMetaDataItem(s);

            // create the bytes
            ByteArrayOutputStream request = new ByteArrayOutputStream();
            SetMetaDataItem.writeRequest(false, false, hash, hosts, bytesToUpload, signature, request);
