...
//                        final String DEV_RSS = "http://dev.proteomecommons.org/tranche/website/newsfeed.xml",  WWW_RSS = "http://tranche.proteomecommons.org/newsfeed.xml",  LOCAL_INTRO = "/org/tranche/gui/image/intro.xhtml";
//
//                        boolean loaded = false;
//
//                        // First, try www server
//                        try {
//                            panel.setDocument(RSSRenderUtil.RSSToHTMLPreview(new URL(WWW_RSS).openConnection().getInputStream(), RSSRenderUtil.NUM_ENTRIES_TO_RENDER), WWW_RSS);
//                            loaded = true;
//                        } catch (Exception e) {
//                        // No thanks
//                        }
...
//                        try {
//                            if (!loaded) {
//                                panel.setDocument(RSSRenderUtil.RSSToHTMLPreview(new URL(DEV_RSS).openConnection().getInputStream(), RSSRenderUtil.NUM_ENTRIES_TO_RENDER), DEV_RSS);
//                                loaded = true;
//                            }
//                        } catch (Exception e) {
//                        // No thanks
