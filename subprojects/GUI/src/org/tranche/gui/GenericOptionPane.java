...
public class GenericOptionPane {
    ...
    public static int showConfirmDialog(Component parentComponent, Object message, String title, int optionType, int messageType, Icon icon) {
        ...
        // Create scoll pane and pad so panel has a "margin"
        ...
        try {
            ...
            // Only want padding for image, so revert to zero
            gbc.ipadx = 0;
            gbc.ipady = 0;
        } catch (Exception ex) {
        ...
        // All items on right of image in rightPanel, use BoxLayout for center alignment
        ...
        // Add the right panel next to image
        gbc.gridy = 0;
        gbc.gridx = 1;
        ...
        // Make sure consistent background
        ...
        // take the waiting off the event dispatch thread if it is on it
    ...
    public static void showMessageDialog(Component parentComponent, Object message, String title, int messageType) {
        ...
        // only wait if the current thread is not the dispatch thread
        if (!SwingUtilities.isEventDispatchThread()) {
            // Block until input received
            while (popup.isVisible()) {
                try {
