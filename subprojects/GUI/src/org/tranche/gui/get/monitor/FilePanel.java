...
public class FilePanel extends JPanel {
    ...
    public void handleFileEvent(GetFileToolEvent agfte) {
        model.handleFileEvent(agfte);
    }
    ...
    private class FileTableModel extends SortableTableModel {
        ...
        public void handleFileEvent(GetFileToolEvent agfte) {
            ...
            if (isNew) {
                ...
                FileRow fr;
                synchronized (rows) {
                    fr = rows.get(agfte.getFileHash());
                    fr.handleFileEvent(agfte);
                }
            }
            resort();
    ...
    private class FileRow {
        ...
        public FileRow(GetFileToolEvent agfte) {
            handleFileEvent(agfte);
        }
        ...
        public void handleFileEvent(GetFileToolEvent agfte) {
            ...
            if (agfte.getAction() == agfte.ACTION_STARTING || agfte.getAction() == agfte.ACTION_STARTED) {
                ...
                if (agfte.getFileName() != null && !agfte.getFileName().equals("")) {
                    fileName = agfte.getFileName();
                }
