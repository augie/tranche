...
public class MetaDataPanel extends JPanel {
    ...
    public void handleMetaDataEvent(AddFileToolEvent event) {
        model.handleMetaDataEvent(event);
    }
    ...
    private class MetaDataTableModel extends SortableTableModel {
        ...
        public void handleMetaDataEvent(AddFileToolEvent agfte) {
            boolean isNew = true;
            synchronized (rows) {
    ...
    private class MetaDataRow {
        ...
        public MetaDataRow(AddFileToolEvent event) {
