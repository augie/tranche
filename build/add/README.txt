***********************************************************
    INSTRUCTIONS FOR RUNNING THE TRANCHE upLOAD TOOL
***********************************************************

PREREQUISITES: 
	* Install Java 5 or later version

1. Check that the ports that are standard for your repository are open.

2. Unzip the downloaded zip file.

3. Navigate to the top-most directory in the unzipped file.

4. Run the following command to print usage: java -jar ./tranche-add.jar
