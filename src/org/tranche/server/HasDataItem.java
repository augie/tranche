...
/**
 * <p>Handles requests for lists of has data chunk requests.</p>
 * @author James "Augie" Hill - augman85@gmail.com
 */
public class HasDataItem extends ServerItem {

    /**
     * @param   server  the server received
     */
    public HasDataItem(Server server) {
        super(Token.HAS_DATA_STRING, server);
    }
    ...
    public final void doAction(InputStream in, OutputStream out, String clientIP) throws Exception {
        ...
        // perform the task
        BooleanArrayCallback.writeResponse(server.getTrancheServer().hasData(hashes), out);
    }
