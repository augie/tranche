...
/**
 * <p>Handles requests for a list of data chunk hashes.</p>
 * @author Jayson Falkner - jfalkner@umich.edu
 * @author James "Augie" Hill - augman85@gmail.com
 */
public class GetDataHashesItem extends ServerItem {

    /**
     * @param   server  the server received
     */
    public GetDataHashesItem(Server server) {
        super(Token.GET_DATA_HASHES_STRING, server);
    }
    ...
    public final void doAction(InputStream in, OutputStream out, String clientIP) throws Exception {
        ...
        GetHashesCallback.writeResponse(server.getTrancheServer().getDataHashes(offset, length), out);
    }
    ...
    public final static void writeRequest(boolean writeHeader, long offset, long length, OutputStream out) throws Exception {
        if (writeHeader) {
            RemoteUtil.writeBytes(Token.GET_DATA_HASHES, out);
        }
