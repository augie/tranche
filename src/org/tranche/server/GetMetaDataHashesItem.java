...
/**
 * <p>Handles requests for meta data hashes.</p>
 * @author Jayson Falkner - jfalkner@umich.edu
 * @author James "Augie" Hill - augman85@gmail.com
 */
public class GetMetaDataHashesItem extends ServerItem {

    /**
     * @param   server  the server received
     */
    public GetMetaDataHashesItem(Server server) {
        super(Token.GET_META_HASHES_STRING, server);
    }
    ...
    public final void doAction(InputStream in, OutputStream out, String clientIP) throws Exception {
        ...
        GetHashesCallback.writeResponse(server.getTrancheServer().getMetaDataHashes(offset, length), out);
    }
     ...
     */
    public final static void writeRequest(boolean writeHeader, long offset, long length, OutputStream out) throws Exception {
        if (writeHeader) {
            RemoteUtil.writeBytes(Token.GET_META_HASHES, out);
        }
