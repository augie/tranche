...
public class GetFileToolPerformanceLog implements GetFileToolListener {
     ...
     */
    public GetFileToolPerformanceLog(File file) throws FileNotFoundException {
    ...
    private void sendEmailAndDeleteFile() {
        ...
        try {
            String subject = "GetFilePerformanceLog [" + Text.getFormattedDate(TimeUtil.getTrancheTimestamp()) + "]: " + this.getFile().getName();
