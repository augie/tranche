 ...
 */
public class GetFileToolReportListener implements GetFileToolListener {

    private final GetFileToolReport report;

    /**
     * 
     * @param report
     */
    public GetFileToolReportListener(GetFileToolReport report) {
        this.report = report;
    }
